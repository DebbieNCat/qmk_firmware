...
#define __QWERTY_L4   XXXXXXX,   XXXXXXX,   XXXXXXX,   MO_FUN,    MO_NUM,    KC_ENT

#define __QWERTY_R1   XXXXXXX,   KC_Y,      KC_U,      KC_I,      KC_O,      KC_P
#define __QWERTY_R2   XXXXXXX,   KC_H,      M_CTLJ,    M_SFTK,    M_ALTL,    M_GCLN
#define __QWERTY_R3   XXXXXXX,   KC_N,      KC_M,      KC_COMM,   KC_DOT,    KC_ESC
#define __QWERTY_R4   KC_BSPC,   LT_NAVS,   LT_MOUD,   XXXXXXX,   XXXXXXX,   XXXXXXX
...
#define __FUN_R2      XXXXXXX,   KC_RALT,   KC_F4,     KC_F5,     KC_F6,     KC_F11
#define __FUN_R3      XXXXXXX,   KC_NUM,    KC_F1,     KC_F2,     KC_F3,     KC_F10
#define __FUN_R4      XXXXXXX,   KC_APP,    XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX
...
#define __NAV_L4      XXXXXXX,   XXXXXXX,   XXXXXXX,   KC_BSPC,   MO_ADJ,    KC_ENT
...
#define _________CKRBD_QWERTY_L4_________                                    MO_FUN,    MO_NUM,    KC_ENT
...
#define _________CKRBD_QWERTY_R3_________   KC_N,      KC_M,      KC_COMM,   KC_DOT,    KC_ESC,    XXXXXXX
#define _________CKRBD_QWERTY_R4_________   KC_BSPC,   LT_NAVS,   LT_MOUD
...
#define _________CKRBD_NUMBER_R2_________   KC_QUOT,   KC_4,      KC_5,      KC_6,      KC_GRV,    KC_RALT
...
#define _________CKRBD_FUNCTION_R2_________ KC_RALT,   KC_F4,     KC_F5,     KC_F6,     KC_F11,    XXXXXXX
#define _________CKRBD_FUNCTION_R3_________ KC_NUM,    KC_F1,     KC_F2,     KC_F3,     KC_F10,    XXXXXXX
...
#define _________CKRBD_NAVIGATE_L4_________                                  KC_BSPC,   KC_SPC,    KC_ENT
