...
#define _M_COMMON_L2   XXXXXXX,   KC_LGUI,   KC_LALT,   KC_LSFT,   KC_LCTL,   XXXXXXX

#define _M_COMMON_R13  __BLANK_NOOP
#define _M_COMMON_R2   XXXXXXX,   KC_LCTL,   KC_LSFT,   KC_LALT,   KC_LGUI,   XXXXXXX

#define _M_QWERTY_L1   XXXXXXX,   KC_Q,      KC_W,      KC_E,      KC_R,      KC_T
#define _M_QWERTY_L2   XXXXXXX,   M_GUIA,    M_ALTS,    M_SFTD,    M_CTLF,    KC_G
#define _M_QWERTY_L3   XXXXXXX,   KC_Z,      KC_X,      KC_C,      KC_V,      KC_B
#define _M_QWERTY_L4   XXXXXXX,   XXXXXXX,   XXXXXXX,   LT_SYMT,   LT_NUMS,   LT_FUNB

#define _M_QWERTY_R1   KC_Y,      KC_U,      KC_I,      KC_O,      KC_P,      XXXXXXX
#define _M_QWERTY_R2   KC_H,      M_CTLJ,    M_SFTK,    M_ALTL,    M_GCLN,    XXXXXXX
#define _M_QWERTY_R3   KC_N,      KC_M,      KC_COMM,   KC_DOT,    KC_RALT,   XXXXXXX
#define _M_QWERTY_R4   KC_DEL,    LT_NAVE,   MO_MMOU,   XXXXXXX,   XXXXXXX,   XXXXXXX

#define _M_NUM_R1      KC_LBRC,   KC_7,      KC_8,      KC_9,      KC_RBRC,   XXXXXXX
#define _M_NUM_R2      KC_QUOT,   KC_4,      KC_5,      KC_6,      KC_GRV,    XXXXXXX
#define _M_NUM_R3      KC_SLSH,   KC_1,      KC_2,      KC_3,      KC_BSLS,   XXXXXXX
...
#define _M_SYM_R2      KC_DQUO,   KC_DLR,    KC_PERC,   KC_CIRC,   KC_TILD,   XXXXXXX
#define _M_SYM_R3      KC_QUES,   KC_EXLM,   KC_AT,     KC_HASH,   KC_PIPE,   XXXXXXX
...
#define _M_FUN_R4      KC_DEL,    KC_APP,    XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX
...
#define _M_NAV_L4      XXXXXXX,   XXXXXXX,   XXXXXXX,   KC_TAB,    MO_MADJ,   KC_BSPC
